...
from app.api.v1.endpoints import auth, users, workers, shifts, rules, schedules, health, assignments, departments, jobs, import_export, analytics, organizations, holidays, onboarding, sandboxes, repairs, employee_portal
...
api_router.include_router(employee_portal.router, prefix="/employee-portal", tags=["Employee Self-Service Portal"])
